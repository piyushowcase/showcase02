            ...
            <div className='relative rounded-3xl bg-[#0b0b0b] border border-white/10 shadow-[0_30px_120px_rgba(0,0,0,0.8)] overflow-hidden'>
              ...
              <div className=' relative px-8 pt-14 pb-10 text-center '>
                ...
                type="button"
                  ...
                  whileTap={{ scale: 0.96 }}
                  className='group relative w-full rounded-xl h-10 bg-white text-black font-semibold shadow-xl overflow-hidden'>
                    {/* <div className='absolute inset-0 bg-gradient-to-r from-zinc-100 to-white opacity-0 group-hover:opacity-100 tansition' /> */}
                  <div
                ...
                <div className='flex items-center gap-4 my-10'>
                  <div className='h-px flex-1 bg-white/10' />
                    <span className='text-sm text-zinc-500 tracking-wide '>Secure Login</span>
                    <div className='h-px flex-1 bg-white/10' />
                  </div>
                  <p className=' text-xs text-zinc-500 leading-relaxed'>By continuing , you agree to our{""}
                    <span className='underline cursor-pointer hover:text-zinc-300 '>Trems of Service</span>{""}and{""}
                    <span className='underline cursor-pointer hover:text-zinc-300 '>Privacy Policy</span>.</p>
                </div>
