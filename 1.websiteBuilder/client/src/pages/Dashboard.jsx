  ...
  return (
    <div className='min-h-screen bg-[#050505] text-white'>
      ...
      <div className='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between'>
        ...
        <button className='px-4 py-2 rounded-lg bg-white text-black text-sm font-semibold hover:scale-105 transition'
    ...
    <div className='max-w-7xl mx-auto px-6 py-10'>
      ...
      className='mb-10'> 
        <p className='text-sm text-zinc-400 mb-1'>Welwcome Back</p>
      ...
      {loading &&(
       ...
       {errors && !loading &&(
        <div className='mt-24 text-center text-red-400'>{errors}</div>
      )}
      {websites.length==0 &&(
