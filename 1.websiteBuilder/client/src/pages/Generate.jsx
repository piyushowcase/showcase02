...
const Generate = () => {
  const PHASES=[
  "Analyzing your idea...","Desiging layout& structure...","Writing HTML & structure...","Final quailty checks..."
];
    ...
    <div className='max-w-6xl mx-auto px-6 py-16'>
      ...
      >
        <h1 className='text-4xl md:text-5xl font-bold mb-5 leading-tight'>
          Build Website with
          <span className='block bg-linear-to-r font=bold from-white to-zinc-400 bg-clip-text text-transparent'>Real AI Power</span>
        </h1>
        <p className=' text-zinc-400 max-w-2xl mx-auto'>
          This process may take several minutes. 
          genweb.ai focuses on quailty, not shortcuts.
        </p>
      </motion.div>
      <div className='mb-14'>
...
{loading &&(
  ...
  >
<div className='flex justify-between mb-2 text-xs text-zinc-400 '><span className=''>{PHASES[phasesIndex]}</span>
<span>{progress}%</span></div>
<div className='h-2 w-full g-white/10 rounded-full overflow-hidden'>
