...
export const generateWebsite = async (req, res) => {
    try {
        ...
        for (let index = 0; index < 2 && !parsed; index++) {
...
export const getWesiteById = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: `get website by id error ${error.message || error}` })
    }
}
 ...
 let parsed=null 
       ...
       if(!parsed){
        ...
        return res.status(200).json({
            ...
            return res.status(500).json({ message: `update website error ${error.message || error}` });
...
export const getAll=async(req,res)=>{
    try {
        ...
        return res.status(200).json(websites)
            ...
            return res.status(500).json({ message: `get all website error ${error.message || error}` });
    }
